...
static func error(error_msg: String, msg_args: Array, print_call_stack: bool = false) -> void:

	var logged_msg: String = _message(error_msg, msg_args, true)
	push_error(logged_msg)


static func warning(warning_msg: String, msg_args: Array) -> void:

	var logged_msg: String = _message(warning_msg, msg_args)
